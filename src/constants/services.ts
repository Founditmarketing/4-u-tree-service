export const servicesData = [
  { 
    ...
    features: [
      ...
      "Precision Directional Felling",
      "Bucket Truck & Crane Operations",
      "Professional Debris Chipping",
  ...
  { 
    ...
    features: [
      ...
      "Material Hauling (Dirt, Gravel, Mulch)",
      "Excavation & Trenching",
      "Compact Loader Operations",
      "Skid Steer Specializations"
    ]
  },
  { 
    ...
    features: [
      "Manual Tree Climbing",
      "Advanced Rigging Systems",
      "Deadwood Splitting & Lowering",
